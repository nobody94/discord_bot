...
function getHealthStatus(hp) {
  if (hp <= 0) return { status: "💔 **GỤC NGÃ**", muteTime: 180000,fee:120000 }; // 3 phút
  if (hp <= 20) return { status: "💘 **NGUY KỊCH**", muteTime: 120000,fee:90000 }; // 2 phút
  if (hp <= 80) return { status: "❤️‍🩹 **CHẤN THƯƠNG**", muteTime: 60000,fee:60000 }; // 1 phút
