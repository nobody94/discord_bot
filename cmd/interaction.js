...
const interactions = {
  ...
  hug: { tag: "hug", color: "#00ff00", msg: "đã trao một cái ôm ấm áp với",lovePoint:5 },
  kiss: {
    tag: "kiss",
    color: "#FF1493",
...
module.exports = {
  ...
  async execute(message, args, commandName) {
    ...
    if (coupleIndex !== -1) {
      ...
      if (points < 0) {
        ...
        if (remaining > 0) {
          ...
          couplesList[coupleIndex].lovePoints = (couplesList[coupleIndex].lovePoints || 0) + added;
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(`**${message.author.username}** ${config.msg} **${target.username}**!${loveNote}`)
      .setImage(gifUrl);
